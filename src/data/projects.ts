...
export const projects: Project[] = [
  {
    ...
    summary: 'Starting a BI project means profiling the data, deciding what matters to the business, writing the queries, and building the report. That setup gets redone from scratch for every new business. I built a working pipeline that turns raw business data into a Power BI project, with profiling, KPI inference, validation, and report generation handled end to end.',
  ...
  },
  {
    ...
    summary: "Investors don't have one place to see portfolio risk alongside the macro conditions around it. That makes questions like \u201Cwhat happens if rates move?\u201D slow to answer. I built a portfolio risk tool that combines market and macro data, risk calculations, forecasts, and interactive scenario analysis in a 4-page Power BI dashboard.",
  ...
  },
  {
    slug: 'solarsense',
    title: 'SolarSense',
    summary: 'A proper solar feasibility study takes 1 to 3 weeks of consultant time. For SMEs across Sub-Saharan Africa, that cost can put the decision out of reach before they even know whether solar makes sense. I built the assessment engine behind the tool, connecting energy consumption and generation models with a deterministic ROI engine through a shared API gateway. The result cut assessment time from 1 to 3 weeks to about 3 minutes.',
  ...
  },
  {
    slug: 'studygapai',
    title: 'StudyGapAI',
    summary: "Students can study hard and still fail because they're reinforcing what they already know while the actual gap causing the failure goes undiagnosed. A useful tool can't just grade the answer. It has to work out why the wrong answer happened. I built a live diagnostic tool that traces wrong answers back to prerequisite gaps, then turns those gaps into a 6-week study plan. It is deployed and currently in use.",
  ...
  },
  {
    ...
    summary: "I built an Alzheimer's image classifier intended to assist with timely flagging, but a working classifier isn't enough. I needed to know which model to trust and whether its performance was actually real. I compared three model architectures and audited the dataset as part of model selection. That audit exposed augmented duplicate scans across the train and test split, so I rejected the original result rather than reporting a leaked performance number.",
